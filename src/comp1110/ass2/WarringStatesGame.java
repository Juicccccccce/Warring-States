...
//        a = rearrange(a);
        ...
        for (int i = 0; i < moveSequence.length(); i++) {
            ...
            if (a == 1) {
                ...
                if (s.length() == 0) {
                    ...
                    char ch = s.charAt(0);
                    int c = Player1.length() - Player1.replaceAll(Character.toString(ch),"").length();
    ...
    public static int returnNumber(char kingdom) {
        if (kingdom == 'a') {
            return 0;
        } else if (kingdom == 'b') {
            return 1;
    ...
    public static char generateMove(String placement) {
        ...
        String validMove = generateAllMove(placement);
    ...
    public static String generateAllMove(String placement) {
        String validMove = "";
